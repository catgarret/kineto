...
| `lazy` | `data-kt-lazy` | Скелет·Блюр·Пиксель·Печать·Растворение при загрузке (изображение·видео) |
| `stylize` | `data-kt-stylize` | Канвас-фильтр дизеринга·ASCII·полутона (изображение·видео) |
