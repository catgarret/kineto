...
Kineto v0.11.0의 공개 API와 소유자 의도를 기준으로 정리한 문서입니다.
...
- [50개 소유자 요구사항](../OWNER_REQUIREMENTS.md)
...
`module-usage-matrix.md`는 53개 모듈의 사용 시점, 피해야 할 조합, 접근성·성능·reduced motion 상태를 데모 뱃지와 함께 관리합니다.
