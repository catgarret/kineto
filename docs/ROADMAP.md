...
> 기준 버전: v0.12.1 · 작성일: 2026-08-02 · 검토: 2026-09-19
...
v0.12.1에서 공개 모듈이 52개에서 55개가 되었습니다(0.12 라인의 첫 게시본입니다. `v0.12.0` 태그는 릴리스 검사가 실패해
게시되지 않았고, 원인과 수정은 CHANGELOG 0.12.1 항목에 있습니다). Lazy에서 분리한 Stylize(디더·아스키·하프톤을 영구 필터로,
