(() => {
  ...
  const DEFAULTS = {
    ...
    dateTime:{date:'',mode:'relative',locale:'ko-KR',numeric:'auto',dateStyle:'medium',timeStyle:'',timeZone:'',live:true,updateInterval:30000,fallback:''},
