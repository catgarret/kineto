...
const CATALOG = [
  ...
  { id: 'braille-pulse', name: 'Braille Pulse', description: 'Braille fill pulse', renderer: 'text-frame', frames: [...'⠀⣀⣤⣶⣿⣿⣿⣶⣤⣀'], defaultInterval: 140, fixedWidth: true, supportedOptions: COMMON, fallbackFrames: ['.', 'o', 'O', 'o'] },
  ...
  { id: 'clock', name: 'Clock', description: 'Clock faces advance through 12, 3, 6 and 9.', renderer: 'text-frame', frames: ['🕛', '🕒', '🕕', '🕘'], defaultInterval: 240, fixedWidth: true, supportedOptions: COMMON, fallbackFrames: ['12', '3 ', '6 ', '9 '] },
