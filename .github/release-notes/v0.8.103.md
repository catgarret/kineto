...
- Keep the 132/118 KB distributable ESM gzip ceilings unchanged while absorbing only the measured Node 24/npm 11 zlib variance with a bounded 1 KB runner margin.
...
- 배포용 ESM gzip의 132/118KB 제품 상한은 유지하고 Node 24/npm 11 zlib 차이에 대해서만 1KB 러너 variance를 제한적으로 허용합니다.
