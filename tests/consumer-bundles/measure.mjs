...
const fixtures = [
  ...
  // bounded 4 KB verification variance so an identical source does not fail
  // only because the runner's generated bytes differ at the rounding edge.
  // The v0.9.0 native Scroll Snap path measured 133.2 KB gzip on Node 24/Linux.
  { name: 'full', budget: 130, variance: 4 },
