...
// live DOM after the page's own scripts run. Run: node tests/browser/nav-parity.mjs
...
console.log(`\nBROWSER nav-parity OK — real Chromium, ${data.left.length} sections represent ${data.registry} modules.`);
