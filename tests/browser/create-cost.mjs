...
await browser.close();
server.close();
console.log(`create-cost OK (${browserName}) — 150 Overflow Text instances created with ${forcedLayouts ?? 'n/a'} forced layouts; fit/overflow decisions, quiet resume and paused start verified.`);
