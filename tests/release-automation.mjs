...
for (const command of [
  ...
  'test:docs', 'test:docs-navigation', 'test:roadmap-readiness', 'test:readiness-gates', 'test:readiness-evidence', 'test:module-metadata', 'test:module-status', 'test:mobile-device-manifest',
