(() => {
  ...
  Object.assign(FIELDS, {
    ...
    flip: [['mode','Move style','select',['none','slide','fade','crossfade','fade-slide','scale']],['duration','Duration (s)','range',0,1,0.02],['stagger','Stagger (s)','range',0,0.15,0.01],['watch','Watch external DOM changes','checkbox'],['viewTransition','Native View Transitions (opt-in)','checkbox']]
  });
