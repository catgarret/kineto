(() => {
  ...
  const FIELDS = {
    ...
    lazy: [
      ...
      ['ditherType','Dither pattern','select',['8x8','4x4','2x2','random','floyd-steinberg','atkinson']],
      ['halftoneShape','Halftone shape','select',['dot','square','line']],
