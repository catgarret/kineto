(() => {
  ...
  const FIELDS = {
    ...
    slider: [['preset','Effect','select',['slide','coverflow']],['axis','Axis','select',['x','y']],['align','Align','select',['center','left']],['loop','Infinite loop','checkbox'],['gap','Gap','range',0,80,2],['perView','Per view','range',1,2.5,0.05],['speed','Speed','range',0.1,2,0.05],['autoplay','Autoplay (ms)','range',0,6000,250],['rotate','Rotate','range',0,70,1],['depth','Depth','range',0,400,10],['minScale','Side scale','range',0.5,1,0.02]],
