(() => {
  ...
  const MODULE_ATTRIBUTES = {
    ...
    counter: 'data-kt-counter', dateTime: 'data-kt-date-time', lazy: 'data-kt-lazy', textSplit: 'data-kt-text-split',
